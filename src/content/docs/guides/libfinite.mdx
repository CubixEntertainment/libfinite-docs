...
<Aside>Documentation for **v0.7.2**</Aside>
...
As of libfinite 0.7.2, no engines have native libfinite support (as engine support is a later focus) but you can still work with libfinite to bring support for the library in your custom engines.
