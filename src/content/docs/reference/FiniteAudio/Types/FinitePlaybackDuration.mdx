...
This struct should be created with [`finite_audio_get_audio_duration`](../../functions/finite_audio_get_audio_duration) and destroyed with [`finite_audio_cleanup`](../../functions/finite_audio_cleanup)
