...
In order to call this function you **must** call [`finite_window_init`](../finite_window_init). To achieve this behavior with a layer-shell window, use [`finite_overlay_set_size_and_position`](../finite_overlay_set_size_and_position) and [`finite_overlay_set_margin`](../finite_overlay_set_margin).
