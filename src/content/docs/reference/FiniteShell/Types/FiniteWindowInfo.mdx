...
This struct is intended to be read-only for most applications. Changes should be applied through [`finite_window_size_set`](/reference/finiteshell//reference/finiteshell/functions/finite_window_size_set/) rather than modifying these fields directly.
