...
A font must be set prior to calling this function with [`finite_draw_set_font`](/reference/finitedraw/functions/finite_draw_set_font/). Failure to do so will throw an error.
