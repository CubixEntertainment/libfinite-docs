---
title: finite_gamepad_joystick_get_value
description: The finite_gamepad_joystick_get_value function
---
...
The `finite_gamepad_joystick_get_value` function gets the given axis value from a [`FiniteJoystickType`](/reference/finiteinput/finitegamepad/enum/finitejoysticktype/)
