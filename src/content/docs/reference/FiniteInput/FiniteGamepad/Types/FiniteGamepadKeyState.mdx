...
`FiniteKeyState`s should **not** be created manually. Developers should let [`finite_input_keyboard_init`](/reference/finiteinput/finitegamepad/functions/finite_input_keyboard_init/) handle creating and managing the FiniteKeyState of each individual key.
